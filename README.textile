...
This gem extends the version that PRX adapted. I would like to acknowledge the changes and fixes
made by Rami Grossman (ramigg). I'm trying to make this gem compatible to Rails 3.2 and above.
I'll update the status when the version is working properly already.
...
<pre><code>
  gem 'apn_on_rails', :git => 'git@github.com:jfjade18/apn_on_rails.git'
</pre></code>
